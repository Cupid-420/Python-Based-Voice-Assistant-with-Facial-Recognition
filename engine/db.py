...
# Single contact without .csv
#query = "INSERT INTO contacts VALUES (null,'amma', '9442903270', 'null')"
#cursor.execute(query)
#con.commit()
...
# Confirm deletion by counting remaining rows
#remaining_contacts = pd.read_sql_query("SELECT COUNT(*) as count FROM contacts;", con)
#remaining_contacts
